...
| 5 | 384112 | System Sensor sampling tube 1.5 ft for D4120 (ducts 12-24 in wide) | smoke detector accessory | none | $20 (Amazon) - $74 (Greenheck) |
...
Not in the pack but check the lost box list:
- D4120 duct smoke detectors, 2 per unit, about $180 each. M7.1 says E.C. furnishes and wires them; the submittal shipped them loose from Greenheck.
  Decide who replaces them before the E.C. is asked to wire.
...
| Smoke detectors | by E.C.; 18/2 for the shutdown contact | dry contact to R-G (submittal p.28) or to fire input R-70 (S6) so the unit alarms instead of just stopping |
...
Do not order until DMG answers; the RFI turnaround is a week, the parts are stock at Kele / Midwest / SupplyHouse.
